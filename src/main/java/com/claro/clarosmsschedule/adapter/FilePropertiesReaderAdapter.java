...
public class FilePropertiesReaderAdapter implements IFileReaderAdapter {
    ...
    public SmppCredential fillSmppCredentialFromProperties() {
        try {
            ...
            smppCredential.timeout = Integer.parseInt(properties.getProperty("application.timeout", "0"));
            smppCredential.startHour = Integer.parseInt(properties.getProperty("application.start_hour", "0"));
            smppCredential.endHour = Integer.parseInt(properties.getProperty("application.end_hour", "0"));
